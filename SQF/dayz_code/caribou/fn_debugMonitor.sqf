	...
	if("ItemMap_Debug" in items player) then {
		...
		<t size='1' font='Bitstream' align='left'>Playercount:</t><t size='1' font='Bitstream' align='right'>%15</t><br/>
		<t size='1' font='Bitstream' align='left'>Diag_Ticktime:</t><t size='1' font='Bitstream' align='right'>%16</t><br/>

		<t size='1' font='Bitstream' align='left'>Next Restart:</t><t size='1' font='Bitstream' align='right'>%9h %10m</t>
	
		",dayz_playerName,r_player_blood,round _humanity,_killsH,_killsB,_kills,null,round(diag_fps),_hours,_minutes,_color,dayz_Survived,_humanityLevel,r_player_blood,(playersNumber west),diag_tickTime];
	} else {
		hintSilent parseText format ["
		<t size='1.20' font='Bitstream' align='center'>%1<br/><br/></t>
		...
		",dayz_playerName,r_player_blood,round _humanity,_killsH,_killsB,_kills,(playersNumber west),round(diag_fps),_hours,_minutes,_color,dayz_Survived,_humanityLevel];
	};